...
// Marco de marca persistente: isologo chico arriba y la web abajo. Aparece
// una vez que el logo hero termina su presentacion.
export const BrandFrame: React.FC<{ appearAt: number }> = ({ appearAt }) => {
  ...
  return (
    <>
      {/* isologo chico bajo la barra roja */}
      <div
        style={{
          position: "absolute",
          top: 108 * s,
